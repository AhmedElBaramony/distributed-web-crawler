...
def master_process():
    ...
    crawled_urls_set = set() # Avoid Duplicate URLs
    ...
    # CHECK WITH THE SQS VERSION AND SEE THE DIFFERENCE
    while urls_to_crawl_queue or any(busy_crawlers.values()):
        ...
        # Check for heartbeats from crawlers
        ...
        # Check if the crawler has timed out & Re-queue the task
